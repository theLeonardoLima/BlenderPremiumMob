...
class HOME_BUILDER_OT_change_units(bpy.types.Operator):
    bl_idname = "blendertomob.change_units"
...
class HOME_BUILDER_MT_change_units(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        for system, length, label in units:
            ...
            op = layout.operator("blendertomob.change_units", text=label, icon=icon)
...
class HOME_BUILDER_OT_flip_dimensions(bpy.types.Operator):
    bl_idname = "blendertomob.flip_dimensions"
...
class HOME_BUILDER_OT_flip_dimension_text(bpy.types.Operator):
    bl_idname = "blendertomob.flip_dimension_text"
    bl_label = "Flip Text"
...
class HOME_BUILDER_OT_update_dimensions(bpy.types.Operator):
    bl_idname = "blendertomob.update_dimensions"
...
class HOME_BUILDER_OT_adjust_dimension_leader_length(bpy.types.Operator):
    bl_idname = "blendertomob.adjust_dimension_leader_length"
...
class HOME_BUILDER_OT_move_dimension_text(bpy.types.Operator):
    ...
    bl_idname = "blendertomob.move_dimension_text"
    bl_label = "Move Text"
...
class HOME_BUILDER_OT_show_dimension_properties(bpy.types.Operator):
    bl_idname = "blendertomob.dimension_options"
...
class HOME_BUILDER_MT_dimension_commands(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator_context = 'INVOKE_DEFAULT'
        layout.operator("blendertomob.dimension_options", text="Dimension Options", icon='WINDOW')
        layout.separator()
        layout.operator("blendertomob.flip_dimensions", text="Flip Dimensions", icon='ARROW_LEFTRIGHT')
        layout.operator("blendertomob.flip_dimension_text", text="Flip Text", icon='FILE_FONT')
        layout.operator("blendertomob.adjust_dimension_leader_length", text="Adjust Leader Length", icon='DRIVER_DISTANCE')
        layout.operator("blendertomob.move_dimension_text", text="Move Text", icon='FONT_DATA')
        layout.operator("blendertomob.update_dimensions", text="Update Dimensions", icon='FILE_REFRESH')
        layout.separator()

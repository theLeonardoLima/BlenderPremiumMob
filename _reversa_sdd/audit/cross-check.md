...
| `A016` | **CRITICAL** | Property Deferred Type | Removed premature reload loop that invalidated imported module symbols during `__init__.py` execution and restored direct PropertyGroup class parameter `type=hb_assets.BTM_AssetLibraryEntry`, resolving `'_PropertyDeferred' object is not iterable` error. | [__init__.py](file:///home/theleoinfo/www/BlenderToMob/__init__.py#L210), [blendertomob/__init__.py](file:///home/theleoinfo/www/BlenderToMob/blendertomob/__init__.py#L150) |
